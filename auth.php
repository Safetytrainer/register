    ...
    if(isset($_POST["btn_submit_auth"]) && !empty($_POST["btn_submit_auth"])){
        ...
        if(isset($_POST["captcha"])){
            ...
            if(!empty($captcha)){
                ...
                if(($_SESSION["rand_auth"] != $captcha) && ($_SESSION["rand_auth"] != "")){
            ...
            $result_query_select = $mysqli->query("SELECT * FROM `person` WHERE login = '".$login."' AND password = '".$password."'");
            if(!$result_query_select){
                ...
                if($result_query_select->num_rows == 1){
                    ...
                    header("HTTP/1.1 301 Moved Permanently");
                    header("Location: ".$address_site."/user.php");
